...
export default function Login() {
    ...
    onSubmit: async (values) => {
      ...
      try {
        const loginResponse = await fetch(
          'https://penny-canchu-api.octave.vip/api/1.0/users/signin',
          {
            method: 'POST',
            headers: {
  ...
  return (
    <><div className="flex flex-col  justify-center mt-5 items-center bg-white">
          <div className="bg-white rounded-lg mt h-[55%] w-[60%]">
              <div className="flex flex-row">
                  ...
                  <div className="light dark:text-white text-mainBlue text-center font-zen-dots text-4xl font-normal" >
                      ...
                      <div className="text-2xl text-center my-10">會員登入</div>
                     
                          <form onSubmit={formikLogin.handleSubmit} className="w-4/5 mx-auto">
                              <div className="mb-5">
                                  <label htmlFor="email1" className="block font-medium text-lg text-gray-700">電子郵件</label>
                                  <input
                                      type="email"
                                      id="email1"
                              ...
                              <div className="mb-5">
                                  <label htmlFor="password1" className="block font-medium text-lg text-gray-700">密碼</label>
                                  <input
                                      type="password"
                                      id="password1"
                  ...
                  <div className="w-[35%] bg-mainBlue rounded-r-lg">
