    ...
    return (
        <>
            <div className="flex flex-col items-center ">
                <div className="bg-white rounded-lg mt-20 md:mt-5 w-[80%] md:w-[60%] shadow-md my-5">
                    <div className="flex flex-row">
                        <div className="w-full md:w-[65%] bg-white p-10 rounded-r-lg">
                            <div className="light dark:text-white text-mainBlue text-center font-zen-dots text-4xl font-normal">
                                EduStream
                            </div>
                            <div className="text-xl text-center my-10">會員註冊</div>
                            ...
                            <form onSubmit={formikRegister.handleSubmit} className="w-4/5 mx-auto">
                                ...
                                <div className="mb-5">
                                    <label htmlFor="repassword" className="block font-medium text-sm text-gray-700">
                                        確認密碼
                                    </label>
                                    <input
                                        type="password"
